...
const baseSections: NavSection[] = [
	{
		...
		items: [
			...
			{
				title: 'Branch Managers Evaluation Summary',
				href: '/reports/branch-manager-evaluation-summary',
				icon: BarChart3,
				permission: 'view branch manager evaluation summary',
			},
			{
				title: 'Inventory Count Summary',
				href: '/reports/inventory-count-summary',
				icon: Warehouse,
	...
	},
	{
		...
		items: [
			...
			{
				title: 'Inventory Completion Tracking',
				href: '/inventory-completion-tracking',
				icon: ClipboardCheck,
				permission: 'view inventory completion tracking',
			},
		],
	},
	{
		...
		groups: [
				...
				items: [
					{
						...
						href: '/budget/expense-budget/create',
						icon: Plus,
						permission: 'manage expense budget anytime|manage expense budget within time window',
					},
					{ title: 'View Expense Budget', href: '/budget/expense-budget', icon: List, permission: 'view expense budgets' },
					{
						title: 'Expense Submission Tracker',
						href: '/budget/expense-budget/submission-tracker',
						icon: ClipboardCheck,
						permission: 'view expense budgets',
					},
				],
			},
			{
			...
			},
			{
				...
				items: [
					...
					{ title: 'Analytics', href: '/budget/weekly-budget/analytics', icon: BarChart3, permission: 'view weekly budgets' },
