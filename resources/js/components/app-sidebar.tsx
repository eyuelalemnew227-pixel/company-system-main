...
const baseSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Fill Evaluation', href: '/my-evaluation', icon: ListChecks, permission: 'Fill Evaluation|view evaluations' },
      { title: 'Evaluation History', href: '/my-evaluation/history', icon: History, permission: 'Evaluation History|view evaluations' },
      { title: 'My Results', href: '/my-results', icon: Award, permission: 'My Results|view evaluations' },
  ...
  },
  {
    ...
    icon: ShoppingCart,
    items: [
      { title: 'New Pre-Order', href: '/pre-orders/create', icon: ClipboardList, permission: 'create pre-orders|create all pre-orders|create walkin pre-orders|create regular pre-orders' },
      ...
      { title: 'Order Types', href: '/settings/order-types', icon: ListChecks, permission: 'view order types|view pre-orders|view pre-order products|manage pre-order payment settings' },
      { title: 'Social Media Sources', href: '/settings/social-media-sources', icon: Globe2, permission: 'view order types|view pre-orders|view pre-order products|manage pre-order payment settings' },
