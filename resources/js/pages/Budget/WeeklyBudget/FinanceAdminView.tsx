...
import { Check, ChevronsUpDown, Filter, Loader2, X, FileText, MessageSquare } from 'lucide-react';
import { type ReactNode, useEffect, useMemo, useState } from 'react';
import { usePopup } from '@/hooks/use-popup';

const breadcrumbs: BreadcrumbItem[] = [
	{ title: 'Weekly Budgets - Finance Admin View', href: '/budget/weekly-budget/finance-admin', className: 'text-[1.3125rem] font-semibold' },
];
...
export default function WeeklyBudgetFinanceAdminView({
	items,
	branches,
	departments,
	paymentCategories,
	...
	const canManageFinanceAdmin = can('manage finance admin budgets');
	...
	function handleBulkUpdate() {
		...
		router.patch(
			'/budget/weekly-budget/finance-admin/bulk',
			{
				ids: selectedIds,
	...
	function saveEditRow(item: WeeklyBudgetRow) {
		const editMode = getFinanceEditMode(item, canManageFinanceAdmin, canOverridePaid);
		if (!editMode) return;
	...
	function applyFilters(
		...
		router.get('/budget/weekly-budget/finance-admin', params, {
			preserveState: true,
			replace: true,
	...
	function clearFilters() {
		...
		router.get(
			'/budget/weekly-budget/finance-admin',
	...
	function exportCsv() {
		...
		window.location.href = `/budget/weekly-budget/finance-admin/export?${queryString}`;
	}
	...
	return (
		<AppLayout breadcrumbs={breadcrumbs}>
			<Head title="Weekly Budgets - Finance Admin View" />
							...
							<div className="flex flex-wrap items-center gap-2 w-full px-4 py-1">
								...
								<div className="w-auto">
									...
									>
										...
										<SelectContent>
											<SelectItem value="all">All CEO Statuses</SelectItem>
											{statusCeos.map((s) => (
								...
								<div className="w-auto">
									...
									>
										...
										<SelectContent>
											<SelectItem value="all">All Finance Statuses</SelectItem>
								...
								<div className="w-auto">
									...
									>
										...
										<SelectContent>
											<SelectItem value="all">All Dept Statuses</SelectItem>
									...
									<Table>
										<TableHeader className="bg-slate-500 dark:bg-slate-700">
											<TableRow>
												...
												{canManageFinanceAdmin && <TableHead className="font-bold text-white">Actions</TableHead>}
											</TableRow>
										</TableHeader>
										<TableBody>
											{items.data.map((item) => {
