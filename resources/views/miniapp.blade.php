...
$translations = [
    ...
    'am' => [
        ...
        'fname_label' => 'የመጀመሪያ ስም', 'lname_label' => 'የአባት ስም', 'surname_label' => 'የአያት ስም (አማራጭ)',
        'phone_label' => 'ስልክ ቁጥር', 'phone_hint' => 'ይህንን ያስገቡ: +251912345678 ወይም 0912345678',
        'select_tortas' => 'ቶርታ ይምረጡ', 'select_branch' => 'የመሰብሰቢያ ቅርንጫፍ ይምረጡ', 'search_branch' => 'ቅርንጫፍ ፈልግ...', 'select_date' => 'የመሰብሰቢያ ቀን ይምረጡ', 'select_payment' => 'የክፍያ ዘዴ ይምረጡ',
        'order_summary' => 'የትዕዛዝ ማጠቃለያ', 'total' => 'ጠቅላላ ክፍያ', 'etb' => 'ብር',
        ...
        'order_success' => 'ትእዛዝዎ ተልኳል!', 'order_number' => 'ቁጥር', 'thank_you' => 'ካልዲስ ቡናን ስለመረጡ እናመሰግናለን። የማረጋገጫ መልእክት ይደርስዎታል።', 'order_again' => 'እንደገና ለማዘዝ',
        'pay_to' => 'ይክፈሉ ለ', 'your_cart' => 'ጋሪ', 'add' => 'አክል',
        'terms_label' => 'እቀበላለሁ', 'terms_link' => 'ውሎችን አንብብ',
        'read_terms' => 'ውሎችና መመሪያዎች',
        'terms_payment_title' => 'የክፍያ ማረጋገጫ',
        'terms_payment_desc' => 'ትዕዛዝዎ ከመረጋገጡ በፊት ክፍያው ሙሉ በሙሉ መፈፀሙ መረጋገጥ አለበት። ከዚህ በታች ያለውን የክፍያ ዘዴ ተጠቅመው ሙሉ ክፍያ ካደረጉ በኋላ ማረጋገጫው ይከናወናል። የተሳሳተ ወይም የጎደለ ክፍያ ካደረጉ ትዕዛዝዎ የሚሰረዝ ይሆናል።',
        'terms_pickup_title' => 'ትዕዛዝን የመሰብሰብ ፖሊሲ',
        'terms_pickup_desc' => 'ትዕዛዞች በመረጡት ቀን እና ቅርንጫፍ ብቻ ነው መሰብሰብ የሚችሉት። ትዕዛዞን እንዲቀበልሎት ሰው ከወከሉ የከፈሉበትን ደረሰኝ እና በካልዲስ ኮፊ በኩል የተላከሎትን መልዕክት ለወከሉት ሰው መስጠትዎን እንዳይረሱ። በመረጡት ቀን እና ቅርንጫፍ ካልሰበሰቡ ትዕዛዝዎ የሚሰረዝ ይሆናል።',
        'terms_full_payment_title' => 'ሙሉ ክፍያ ያስፈልጋል',
        'terms_full_payment_desc' => 'የሰጡት ትዕዛዝ የተጠየቁት ምርቶች ሙሉ ክፍያ ካደረጉ በኋላ ብቻ የሚሰራ ይሆናል። የክፍያ ታሪክ የሌለው ወይም ምንም አይነት ክፍያ ያልተገኘበት ትዕዛዝ ተቀባይነት አይኖረውም።',
        ...
        'error_select_branch' => 'የመሰብሰቢያ ቅርንጫፍ ይምረጡ።', 'error_select_date' => 'የመሰብሰቢያ ቀን ይምረጡ።', 'error_select_payment' => 'የክፍያ ዘዴ ይምረጡ።', 'error_select_source' => 'ምንጭ ይምረጡ።', 'error_slip' => 'ስክሪንሾት ወይም PDF አስፈላጊ ነው።',
        'summary_customer' => 'ደንበኛ', 'summary_pickup' => 'መሰብሰቢያ', 'summary_payment' => 'ክፍያ', 'summary_proof' => 'ማረጋገጫ', 'summary_name' => 'ስም', 'summary_phone' => 'ስልክ', 'summary_branch' => 'ቅርንጫፍ', 'summary_date' => 'ቀን', 'summary_ref' => 'ሪፈረንስ ቁጥር', 'summary_slip' => 'ስክሪንሾት',
        'flow_step_1' => 'የምርት ምርጫ', 'flow_step_2' => 'የመሰብሰቢያ ቦታ', 'flow_step_3' => 'ክፍያ', 'flow_step_4' => 'ተቀበል',
        'help_support' => 'እገዛ', 'join_community' => 'ማህበረሰባችንን ተቀላቀል',
        'warning_first_page' => 'የክፍያ ማረጋገጫ ሳያያይዙ ትዕዛዝዎ አይሰራም።',
        'source_instagram' => 'Instagram', 'source_sms' => 'SMS',
        'exit_warning_title' => 'ትዕዛዝ አልተላከም', 'exit_warning_msg' => 'ትዕዛዝዎን ሳያስገቡ እየወጡ ነው።', 'exit_confirm' => 'አዎ, ውጣ', 'exit_cancel' => 'አይ, ቀጥል',
        'payment_warning' => "ክፍያ ካደረጉ በኋላ ስክሪንሾት ይውሰዱ።",
        'view_order' => 'ትዕዛዝዎን ይመልከቱ', 'track_order' => 'ትዕዛዝዎን ይከታተሉ',
        'warning_slide' => 'ማሳሰቢያ፦ የክፍያ ደረሰኙ ከዚህ ቅጽ ጋር አብሮ ካልተያያዘ ትዕዛዝዎ ተቀባይነት አይኖረውም።',
        'choose_lang' => 'ቋንቋ ይምረጡ', 'call_us' => 'ይደውሉልን',
        'welcome_msg' => 'የበዓል ቶርታዎን ቅድሚያ ያስይዙ እና በቅርበት በመረጡት ቅርንጫፍ ይውሰዱ።',
        'summary_source' => 'ያወቁት', 'summary_items' => 'የተዘዙ እቃዎች',
        'telegram_only_title' => 'ቴሌግራም ያስፈልጋል', 'telegram_only_msg' => 'ይህ አፕልኬሽን በቴሌግራም ውስጥ ብቻ ሊሰራ ይችላል።', 'open_telegram' => 'በቴሌግራም ይክፈቱ',
        ...
        'digits_counter' => 'አሃዝ',
        'confirm_order_title' => 'ትዕዛዙን ያረጋግጡ',
        'confirm_order_msg' => 'ትዕዛዙን ለመላክ ይፈልጋሉ? እባክዎ ደረሰኙን በደንብ ያረጋግጡ።',
        ...
        'confirm_total_label' => 'የትዕዛዝ ጠቅላላ'
    ]
];
