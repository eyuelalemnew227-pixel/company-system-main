        ...
        if (Schema::hasTable('training_attendances')) {
            Schema::table('training_attendances', function (Blueprint $table) {
                if (!Schema::hasColumn('training_attendances', 'training_schedule_id')) {
                    $table->unsignedBigInteger('training_schedule_id')->nullable()->after('id');
                }
                if (!Schema::hasColumn('training_attendances', 'training_schedule_item_id')) {
                    $table->unsignedBigInteger('training_schedule_item_id')->nullable()->after('training_schedule_id');
                }
                ...
                if (!Schema::hasColumn('training_attendances', 'recorded_by_user_id')) {
                    $table->unsignedBigInteger('recorded_by_user_id')->nullable()->after('notes');
                }
            });
        }
    }
